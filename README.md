...
/* Input Style */
    .input-box { width: 100%; padding: 14px; margin-bottom: 12px; border-radius: 8px; border: 1px solid #333; background: #000; color: white; font-size: 15px; box-sizing: border-box; }  /* Button */
    .btn { background: linear-gradient(180deg, #22c55e, #1b4332); color: white; padding: 18px; width: 100%; border: none; border-radius: 12px; font-size: 18px; font-weight: bold; cursor: pointer; }    /* Reviews (Lambi List) */
